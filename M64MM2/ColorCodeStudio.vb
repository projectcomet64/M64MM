...
Imports M64MM2.ShadowFunctions
...
Public Class ColorCodeStudio
    ...
    Private Sub ColorCodeStudio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        SHADM_btn.Text = My.Resources.CCS_ShadingMode
        RESTOREBTN.Text = My.Resources.CCS_RestoreSh
    ...
    Private Sub X_BAR_Scroll(sender As Object, e As EventArgs) Handles X_BAR.ValueChanged
        ChangeShadowX(Hex(CSByte(X_BAR.Value)))
    End Sub

    Private Sub Y_BAR_Scroll(sender As Object, e As EventArgs) Handles Y_BAR.ValueChanged
        ChangeShadowY(Hex(CSByte(Y_BAR.Value)))
    End Sub

    Private Sub Z_BAR_Scroll(sender As Object, e As EventArgs) Handles Z_BAR.ValueChanged
        ChangeShadowZ(Hex(CSByte((Z_BAR.Value))))
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles SHADM_btn.Click
        If ShadowMode = 0 Then
            SHADM_btn.Text = My.Resources.CCS_ColorMode
            X_BAR.Visible = True
            Y_BAR.Visible = True
            Z_BAR.Visible = True
            SX_lb.Visible = True
    ...
    Private Sub SZ_lb_Click(sender As Object, e As EventArgs) Handles SZ_lb.Click
